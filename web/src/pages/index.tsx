  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto gap-28 grid grid-cols-2 items-center">
      <main>
        ...
        <h1 className="mt-14 text-white text-5xl font-bold leading-tight">Crie seu proprio bolão da copa e compartilhe entre amigos!</h1>

        <div className="mt-10 flex items-center gap-2">
          <Image src={usersAvatarExampleImg} alt="Avatares" />
      ...
      <Image src={appPreviewImg} alt="Dois celulares exibindo previa da aplicacao nlw copa" quality={100} />
    </div>
  )
}
